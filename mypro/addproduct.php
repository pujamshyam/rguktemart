...
<div class="frm">
  ...
  <div class="form-outline mb-4">
    <input type="hidden" id="form6Example3" class="form-control" />
    
  </div>

  
  <div class="form-outline mb-4">
    <input type="text" id="form6Example4"  name="username" class="form-control" placeholder="Enter your Name" required />
   
  </div>

  
  <div class="form-outline mb-4">
    <input type="text" id="form6Example4"  name="prdctname" class="form-control"  placeholder="Enter Product Name" required/>
   </div>

  
  <div class="form-outline mb-4">
    <input type="number" id="form6Example6" name="prdctprice" class="form-control" placeholder="Enter Product Price(in .Rs)" required/>
  ...
  <div class="form-outline mb-4">
  <label class="sp" >Upload product image</label>
    <input  id="form6Example6" class="form-control" type="file" name="file" required accept="image/png, image/png, image/jpeg"/>
  ...
  <button type="submit" class="btn btn-primary btn-block mb-4" name="submit" >Add Product</button>
</form>
</div>
