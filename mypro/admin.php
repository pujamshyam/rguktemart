...
<div class="frm">
  ...
  <button type="submit" class="btn btn-primary btn-block mb-4" name="submit" onclick="order()">Order Details</button>
  <button type="submit" class="btn btn-primary btn-block mb-4" name="submit"  onclick="meg()">Messages</button>
  <button type="submit" class="btn btn-primary btn-block mb-4" name="submit"  onclick="data()">DataBase Details</button>
