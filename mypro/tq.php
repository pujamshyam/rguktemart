...
if(isset($_POST['submit'])){
  ...
  $tidd = $_POST['ti'];
      ...
      $sql="insert into `purchasedata` (name,number,tid) values 
      ('$un','$phn','$tidd')";
...
<div class="frm">
    <h3>RGUKT <i class="fa fa-shopping-cart" aria-hidden="true"></i> E-Mart</h3>
    <div class="pp">
    <img class="tqq" src="tick.png">
    <h2>Transaction Successful</h2>
     
    <p  class="pq">If the provided Transaction Id is correct you will get the product (you will recive call from our team) with in 2 working days. If you are facing any problem contact us, the amount is fully refunded !<p>
    </p>
</div>
